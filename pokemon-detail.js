...
function setTypeBackgroundColor(pokemon) {
  ...
  styleTag.innerHTML = `.stats-wrap .progress-bar::webkit-progress-bar {background-color_ rgba(${rgbaColor}, 0.5);}.stats-wrap .progress-bar::-webkit-progress-value {background-color: ${color};}`;
...
function displayPokemonDetails(pokemon) {
  ...
  types.forEach(({ type }) => {
    createAndAppendElement(typeWrapper, "p", {
      className: `body-fonts type ${type.name}`,
